    ...
    return (
        <section className="service-block">
            <div className="container">
                <div className="row align-items-center mb-5 our-service-row" id='lead-generation'>
                    <div className="col-md-6 our-service-box pe-4">
                    ...
                    <div className="col-md-6">
                        <img src={leadGeneration} alt="lead generation" className='service-img' />
                    </div>
                </div>
                <div className="row align-items-center mb-5 our-service-row" id='email-marketing'>
                    <div className="col-md-6">
                        <img src={emailMarketing} alt="lead generation" className='service-img' />
                    </div>
                    <div className="col-md-6 our-service-box ps-4">
                ...
                <div className="row align-items-center mb-5 our-service-row" id='content-marketing'>
                    <div className="col-md-6 our-service-box pe-4">
                    ...
                    <div className="col-md-6">
                        <img src={contentMarketing} alt="lead generation" className='service-img' />
                    </div>
                </div>
                <div className="row align-items-center mb-5 our-service-row" id='social-media-leads'>
                    <div className="col-md-6">
                        <img src={seoOptimization} alt="lead generation" className='service-img' />
                    </div>
                    <div className="col-md-6 our-service-box ps-4">
                ...
                <div className="row align-items-center mb-5 our-service-row" id='seo-optimization'>
                    <div className="col-md-6 our-service-box pe-4">
                    ...
                    <div className="col-md-6">
                        <img src={socialMediaLeadGeneration} alt="lead generation" className='service-img' />
                    </div>
                </div>
                <div className="row align-items-center mb-5 our-service-row" id='ppc-advertising'>
                    <div className="col-md-6">
                        <img src={payPerClick} alt="lead generation" className='service-img' />
                    </div>
                    <div className="col-md-6 our-service-box ps-4">
